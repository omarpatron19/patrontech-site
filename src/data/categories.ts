export const categories = [
  { name: 'Azure', icon: 'AZ', description: 'Servicios, migraciones, redes, plataforma y operación.' },
  { name: 'Inteligencia Artificial', icon: 'AI', description: 'Microsoft Foundry, Azure OpenAI, agentes y Copilot.' },
  { name: 'Arquitectura Cloud', icon: 'AC', description: 'Patrones, decisiones, resiliencia y diseño empresarial.' },
